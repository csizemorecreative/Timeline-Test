...
exports.MuiToggleButton = {
    ...
    styleOverrides: {
        root: ({ theme }) => ({
            ...
            '&:hover': {
                color: base_tokens_json_1.default.tokens.palette.content.content700,
                background: base_tokens_json_1.default.tokens.palette.content.content300
            },
            '&.MuiToggleButtonGroup-grouped': {
                '&:not(:first-of-type), &:not(:last-of-type)': {
                    ...
                    '&.Mui-selected': {
                        borderTop: `1px solid ${base_tokens_json_1.default.tokens.palette.content.content300}`,
                        borderLeft: `1px solid ${base_tokens_json_1.default.tokens.palette.content.content300}`,
                        '& + .Mui-selected': {
                            borderLeft: `1px solid ${base_tokens_json_1.default.tokens.palette.content.content300}`,
                            marginLeft: 0
                        }
            ...
            '&.Mui-selected': {
                border: `1px solid ${base_tokens_json_1.default.tokens.palette.content.content300}`,
