...
function T(e) {
  var _a;
  (_a = e == null ? void 0 : e.parentElement) == null ? void 0 : _a.removeChild(e);
}
function k(e, t2) {
  let n2;
...
function F(e, t2, n2, i2) {
  if (n2 = n2 || {}, (b == null ? void 0 : b.createEvent) && (e.dispatchEvent || e.fireEvent && e !== r())) {
  ...
  let n2, i2 = [e, ...t2], o2 = {}, r2 = function(e2, t3) {
    return "object" != typeof e2 && (e2 = {}), M(t3, function(n3, i3) {
      if ("__proto__" !== i3 && "constructor" !== i3) {
        let o3;
        !A(n3, true) || (o3 = n3 == null ? void 0 : n3.constructor, A(n3, true) && !N(n3) && (o3 == null ? void 0 : o3.name) && "Object" !== o3.name) || N(n3) ? e2[i3] = t3[i3] : e2[i3] = r2(e2[i3] || {}, n3);
      }
    }), e2;
  };
...
var $ = class {
  ...
  setButtonText() {
    var _a, _b;
    let e = this.chart, t2 = (_a = e.exporting) == null ? void 0 : _a.divElements, n2 = e.options.exporting, i2 = n2 && n2.buttons && n2.buttons.contextButton.menuItems, o2 = e.options.lang;
    if ((n2 == null ? void 0 : n2.menuItemDefinitions) && (o2 == null ? void 0 : o2.exitFullscreen) && o2.viewFullscreen && i2 && t2) {
      ...
      e2 && l().setElementHTML(e2, this.isOpen ? o2.exitFullscreen : ((_b = n2.menuItemDefinitions.viewFullscreen) == null ? void 0 : _b.textKey) || o2.viewFullscreen);
    }
  }
  toggle() {
...
var V = { ajax: function(e) {
  ...
  n2.open((e.type || "get").toUpperCase(), e.url, true), ((_a = e.headers) == null ? void 0 : _a["Content-Type"]) || n2.setRequestHeader("Content-Type", t2[e.dataType || "json"] || t2.text), M(e.headers, function(e2, t3) {
    ...
    if (4 === n2.readyState) {
      if (200 === n2.status) {
        ...
        return (_a2 = e.success) == null ? void 0 : _a2.call(e, t3, n2);
      }
...
V.post = async function(e, t2, n2) {
  ...
  let o2 = await G.fetch(e, { method: "POST", body: i2, ...n2 });
  if (o2.ok) {
...
var ee = class _ee {
  ...
  static async imageToDataURL(e, t2, n2) {
    let i2 = await _ee.loadImage(e), o2 = K.createElement("canvas"), r2 = o2 == null ? void 0 : o2.getContext("2d");
  ...
  static prepareImageOptions(e) {
    var _a;
    let t2 = (e == null ? void 0 : e.type) || "image/png", n2 = (e == null ? void 0 : e.libURL) || ((_a = W.exporting) == null ? void 0 : _a.libURL);
    return { type: t2, filename: ((e == null ? void 0 : e.filename) || "chart") + "." + ("image/svg+xml" === t2 ? "svg" : t2.split("/")[1]), scale: (e == null ? void 0 : e.scale) || 1, libURL: (n2 == null ? void 0 : n2.slice(-1)) !== "/" ? n2 + "/" : n2 };
  }
  static sanitizeSVG(e, t2) {
    var _a;
    let n2 = e.indexOf("</svg>") + 6, i2 = e.indexOf("<foreignObject") > -1, o2 = e.substr(n2);
    return e = e.substr(0, n2), i2 ? e = e.replace(/(<(?:img|br).*?(?=\>))>/g, "$1 />").replace(/(<svg(?![^>]*xmlns=)[^>]*)>/g, '$1 xmlns="http://www.w3.org/2000/svg">') : o2 && ((_a = t2 == null ? void 0 : t2.exporting) == null ? void 0 : _a.allowHTML) && (o2 = '<foreignObject x="0" y="0" width="' + t2.chart.width + '" height="' + t2.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' + o2.replace(/(<(?:img|br).*?(?=\>))>/g, "$1 />").replace(/(<svg(?![^>]*xmlns=)[^>]*)>/g, '$1 xmlns="http://www.w3.org/2000/svg">') + "</body></foreignObject>", e = e.replace("</svg>", o2 + "</svg>")), e = e.replace(/zIndex="[^"]+"/g, "").replace(/symbolName="[^"]+"/g, "").replace(/jQuery\d+="[^"]+"/g, "").replace(/url\(("|&quot;)(.*?)("|&quot;)\;?\)/g, "url($2)").replace(/url\([^#]+#/g, "url(#").replace(/<svg /, '<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ (NS\d+\:)?href=/g, " xlink:href=").replace(/(<image[^>]*) xlink:href=/g, "$1 href=").replace(/\n+/g, " ").replace(/&nbsp;/g, " ").replace(/&shy;/g, "­");
  }
  ...
  addButton(e) {
    var _a;
    let t2, n2 = this, i2 = n2.chart, o2 = i2.renderer, r2 = D((_a = i2.options.navigation) == null ? void 0 : _a.buttonOptions, e), a2 = r2.onclick, l2 = r2.menuItems, s2 = r2.symbolSize || 12;
  ...
  beforePrint() {
    ...
    this.isPrinting = true, (_a = e.pointer) == null ? void 0 : _a.reset(void 0, 0), F(e, "beforePrint"), n2 && e.chartWidth > n2 && (i2.resetParams = [e.options.chart.width, void 0, false], e.setSize(n2, void 0, false)), [].forEach.call(i2.childNodes, function(e2, t3) {
  ...
  contextMenu(e, t2, n2, i2, o2, r2, a2) {
    ...
    m2 || (s2.contextMenuEl = c2[u2] = m2 = O("div", { className: e }, { position: "absolute", zIndex: 1e3, padding: f2 + "px", pointerEvents: "auto", ...c2.renderer.style }, ((_a = c2.scrollablePlotArea) == null ? void 0 : _a.fixedDiv) || c2.container), g2 = O("ul", { className: "highcharts-menu" }, c2.styledMode ? {} : { listStyle: "none", margin: 0, padding: 0 }, m2), c2.styledMode || C(g2, k({ MozBoxShadow: "3px 3px 10px #0008", WebkitBoxShadow: "3px 3px 10px #0008", boxShadow: "3px 3px 10px #0008" }, (h2 == null ? void 0 : h2.menuStyle) || {})), m2.hideMenu = function() {
    ...
    }, (_b = s2.events) == null ? void 0 : _b.push(E(m2, "mouseleave", function() {
      m2.hideTimer = Z.setTimeout(m2.hideMenu, 500);
    }), E(m2, "mouseenter", function() {
      R(m2.hideTimer);
    }), E(K, "mouseup", function(t3) {
      var _a2;
      ((_a2 = c2.pointer) == null ? void 0 : _a2.inClass(t3.target, e)) || m2.hideMenu();
    }), E(m2, "click", function() {
      var _a2;
      ((_a2 = c2.exporting) == null ? void 0 : _a2.openMenu) && m2.hideMenu();
    })), t2.forEach(function(e2) {
      var _a2;
      if ("string" == typeof e2 && ((_a2 = s2.options.menuItemDefinitions) == null ? void 0 : _a2[e2]) && (e2 = s2.options.menuItemDefinitions[e2]), A(e2, true)) {
        let t3;
        e2.separator ? t3 = O("hr", void 0, void 0, g2) : ("viewData" === e2.textKey && s2.isDataTableVisible && (e2.textKey = "hideData"), t3 = O("li", { className: "highcharts-menu-item", onclick: function(t4) {
          ...
          C(this, (h2 == null ? void 0 : h2.menuItemHoverStyle) || {});
        }, t3.onmouseout = function() {
          C(this, (h2 == null ? void 0 : h2.menuItemStyle) || {});
        }, C(t3, k({ cursor: "pointer" }, (h2 == null ? void 0 : h2.menuItemStyle) || {})))), s2.divElements.push(t3);
      }
    }), s2.divElements.push(g2, m2), s2.menuHeight = m2.offsetHeight, s2.menuWidth = m2.offsetWidth);
    let y2 = { display: "block" };
    n2 + (s2.menuWidth || 0) > p2 ? y2.right = p2 - n2 - o2 - f2 + "px" : y2.left = n2 - f2 + "px", i2 + r2 + (s2.menuHeight || 0) > d2 && ((_c = a2.alignOptions) == null ? void 0 : _c.verticalAlign) !== "top" ? y2.bottom = d2 - i2 - f2 + "px" : y2.top = i2 + r2 - f2 + "px", C(m2, y2), C(c2.renderTo, { overflow: "" }), C(c2.container, { overflow: "" }), c2.exporting && (c2.exporting.openMenu = true), F(c2, "exportMenuShown");
  }
  destroy(e) {
  ...
  getFilename() {
    var _a;
    let e = (_a = this.chart.userOptions.title) == null ? void 0 : _a.text, t2 = this.options.filename;
  ...
  getSVG(e, t2) {
    ...
    a2.plotOptions = D(n2.userOptions.plotOptions, e == null ? void 0 : e.plotOptions), a2.time = D(n2.userOptions.time, e == null ? void 0 : e.time);
    let l2 = O("div", void 0, { position: "absolute", top: "-9999em", width: n2.chartWidth + "px", height: n2.chartHeight + "px" }, K.body), s2 = n2.renderTo.style.width, c2 = n2.renderTo.style.height, h2 = ((_a = a2.exporting) == null ? void 0 : _a.sourceWidth) || a2.chart.width || /px$/.test(s2) && parseInt(s2, 10) || (a2.isGantt ? 800 : 600), p2 = ((_b = a2.exporting) == null ? void 0 : _b.sourceHeight) || a2.chart.height || /px$/.test(c2) && parseInt(c2, 10) || 400;
    k(a2.chart, { animation: false, renderTo: l2, forExport: true, renderer: "SVGRenderer", width: h2, height: p2 }), a2.exporting && (a2.exporting.enabled = false), delete a2.data, a2.series = [], n2.series.forEach(function(e2) {
      var _a2;
      (r2 = D(e2.userOptions, { animation: false, enableMouseTracking: false, showCheckbox: false, visible: e2.visible })).isInternal || ((_a2 = a2 == null ? void 0 : a2.series) == null ? void 0 : _a2.push(r2));
    });
    let d2 = {};
    ...
    let u2 = (t3) => {
      ...
      e && ["xAxis", "yAxis", "series"].forEach(function(n3) {
        ...
        if (i3) {
          var o3;
          let t4 = n3.getExtremes(), r3 = (L(o3 = (e == null ? void 0 : e[n3.coll]) || {}) ? o3 : [o3])[0], a3 = "min" in r3 ? r3.min : t4.userMin, l3 = "max" in r3 ? r3.max : t4.userMax;
          (void 0 !== a3 && a3 !== i3.min || void 0 !== l3 && l3 !== i3.max) && i3.setExtremes(a3 ?? void 0, l3 ?? void 0, true, false);
        }
      });
      let o2 = t3.exporting;
      return (o2 == null ? void 0 : o2.options.applyStyleSheets) && this.applyShadowDOMStyles(t3), i2 = (o2 == null ? void 0 : o2.getChartHTML(n2.styledMode || ((_a2 = a2 == null ? void 0 : a2.exporting) == null ? void 0 : _a2.applyStyleSheets))) || "", F(n2, "getSVG", { chartCopy: t3 }), i2 = _ee.sanitizeSVG(i2, a2), a2 = void 0, t3.destroy(), T(l2), i2;
    };
    return t2 ? new Promise((e2) => new n2.constructor(a2 || {}, function(t3) {
      var _a2;
      (_a2 = n2.callback) == null ? void 0 : _a2.call(this, t3), e2(u2(this));
  ...
  applyShadowDOMStyles(e) {
    ...
    o2 == null ? void 0 : o2.querySelectorAll("style").forEach((t3) => {
  ...
  async getSVGForExport(e, t2) {
    let n2 = this.options;
    return await this.getSVG(D({ chart: { borderRadius: 0 } }, n2.chartOptions, t2, { exporting: { sourceWidth: (e == null ? void 0 : e.sourceWidth) || n2.sourceWidth, sourceHeight: (e == null ? void 0 : e.sourceHeight) || n2.sourceHeight } }), true);
  }
  inlineStyles() {
    var _a;
    let e, t2 = _ee.inlineDenylist, n2 = _ee.inlineAllowlist, i2 = {}, o2 = O("iframe", void 0, { width: "1px", height: "1px", visibility: "hidden" }, K.body), r2 = (_a = o2.contentWindow) == null ? void 0 : _a.document;
  ...
  async localExport(e, t2) {
    ...
    try {
      ...
      for (let n4 of (await this.getSVGForExport(e, t2), a2 ? Array.from(a2) : [])) if (r2 = n4.getAttributeNS("http://www.w3.org/1999/xlink", "href")) {
        ...
        let t3 = await _ee.imageToDataURL(r2, (e == null ? void 0 : e.scale) || 1, (e == null ? void 0 : e.type) || "image/png");
        n4.setAttributeNS("http://www.w3.org/1999/xlink", "href", t3);
      } else n4.parentNode.removeChild(n4);
      let l3 = i2 == null ? void 0 : i2.querySelector("svg");
      l3 && !((_c = (_b = (_a = e.chartOptions) == null ? void 0 : _a.chart) == null ? void 0 : _b.style) == null ? void 0 : _c.fontFamily) && await _ee.inlineFonts(l3);
      let s2 = (n3 = i2 == null ? void 0 : i2.innerHTML, _ee.sanitizeSVG(n3 || "", o2));
  ...
  print() {
    ...
    this.isPrinting || (_ee.printingChart = e, X || this.beforePrint(), setTimeout(() => {
      Z.focus(), Z.print(), X || setTimeout(() => {
        var _a;
        (_a = e.exporting) == null ? void 0 : _a.afterPrint();
      }, 1e3);
    }, 1));
  }
  render() {
    let e = this, { chart: t2, options: n2 } = e, i2 = (e == null ? void 0 : e.isDirty) || !(e == null ? void 0 : e.svgElements.length);
    e.buttonOffset = 0, e.isDirty && e.destroy(), i2 && false !== n2.enabled && (e.events = [], e.group || (e.group = t2.renderer.g("exporting-group").attr({ zIndex: 3 }).add()), M(n2 == null ? void 0 : n2.buttons, function(t3) {
      e.addButton(t3);
    }), e.isDirty = false);
  }
  resolveCSSVariables() {
    Array.from(this.chart.container.querySelectorAll("*")).forEach((e) => {
      ["color", "fill", "stop-color", "stroke"].forEach((t2) => {
        ...
        (n2 == null ? void 0 : n2.includes("var(")) && e.setAttribute(t2, getComputedStyle(e).getPropertyValue(t2));
        let i2 = (_a = e.style) == null ? void 0 : _a[t2];
        (i2 == null ? void 0 : i2.includes("var(")) && (e.style[t2] = getComputedStyle(e).getPropertyValue(t2));
      });
    });
  }
  update(e, t2) {
...
ee.inlineAllowlist = [], ee.inlineDenylist = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/, /[lL]ogical(Width|Height)$/, /^parentRule$/, /^(cssRules|ownerRules)$/, /perspective/, /TapHighlightColor/, /^transition/, /^length$/, /^\d+$/], ee.inlineToAttributes = ["fill", "stroke", "strokeLinecap", "strokeLinejoin", "strokeWidth", "textAnchor", "x", "y"], ee.loadEventDeferDelay = 150 * !!_, ee.unstyledElements = ["clipPath", "defs", "desc"], (function(e) {
  ...
  function i2({ alignTo: e2, key: t3, textPxLength: n3 }) {
    var _a, _b, _c;
    let i3 = this.options.exporting, { align: o2, buttonSpacing: r2 = 0, verticalAlign: a2, width: l2 = 0 } = D((_a = this.options.navigation) == null ? void 0 : _a.buttonOptions, (_b = i3 == null ? void 0 : i3.buttons) == null ? void 0 : _b.contextButton), s2 = e2.width - n3, c2 = l2 + r2;
    ((i3 == null ? void 0 : i3.enabled) ?? true) && "title" === t3 && "right" === o2 && "top" === a2 && s2 < 2 * c2 && (s2 < c2 ? e2.width -= c2 : ((_c = this.title) == null ? void 0 : _c.alignValue) !== "left" && (e2.x -= c2 - s2 / 2));
  }
  e.compose = function(o2, r2) {
    w.compose(r2), $.compose(o2), H(z, "Exporting") && (k(c().prototype, { exportChart: async function(e2, t3) {
      var _a;
      await ((_a = this.exporting) == null ? void 0 : _a.exportChart(e2, t3));
    }, getChartHTML: function(e2) {
      var _a;
      return (_a = this.exporting) == null ? void 0 : _a.getChartHTML(e2);
    }, getFilename: function() {
      var _a;
      return (_a = this.exporting) == null ? void 0 : _a.getFilename();
    }, getSVG: function(e2) {
      var _a;
      return (_a = this.exporting) == null ? void 0 : _a.getSVG(e2, false);
    }, print: function() {
      var _a;
      ...
      var _a, _b;
      e.printingChart && (t3.matches ? (_a = e.printingChart.exporting) == null ? void 0 : _a.beforePrint() : (_b = e.printingChart.exporting) == null ? void 0 : _b.afterPrint());
    }), q(v));
  };
})(ee || (ee = {}));
var et = r();
...
//# sourceMappingURL=highcharts_esm_modules_exporting__js.js.map
